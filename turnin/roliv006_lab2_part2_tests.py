...
tests = [ 
    {'description': 'Test 1: PINA: 0x01 => PORTB: 0x01',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'Test 2: PINA: 0x02 => PORTB: 0x01',
    'steps': [ {'inputs': [('PINA',0x02)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'Test 3: "PINA: 0x04 => PORTB: 0x01"',
    'steps': [ {'inputs': [('PINA',0x04)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'Test 4: PINA: 0x08 => PORTB: 0x01',
    'steps': [ {'inputs': [('PINA',0x08)], 'iterations': 1 } ],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'Test 5: PINA: 0x0F => PORTB: 0x04',
    'steps': [ {'inputs': [('PINA',0x0F)], 'iterations': 1 } ],
    'expected': [('PORTC',0x04)],
    },
    {'description': 'Test 6: PINA: 0x00 => PORTB: 0x00',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 1 } ],
    'expected': [('PORTC',0x00)],
    },
    {'description': 'Test 7: PINA: 0x0C => PORTB: 0x02',
    'steps': [ {'inputs': [('PINA',0x0C)], 'iterations': 1 } ],
    'expected': [('PORTC',0x02)],
    },
    {'description': 'Test 8: PINA: 0x0E => PORTB: 0x03',
