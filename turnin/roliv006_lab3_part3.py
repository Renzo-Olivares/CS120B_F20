...
tests = [ 
    ...
    {'description': 'Test 16: PINA: 0x31 => PORTC: 0xE0',
    'steps': [ {'inputs': [('PINA',0x31)], 'iterations': 1 } ],
    'expected': [('PORTC',0xE0)],
    },
    {'description': 'Test 17: PINA: 0x32 => PORTC: 0xE0',
    'steps': [ {'inputs': [('PINA',0x32)], 'iterations': 1 } ],
    'expected': [('PORTC',0xE0)],
    },
    {'description': 'Test 18: PINA: 0x33 => PORTC: 0xF0',
    'steps': [ {'inputs': [('PINA',0x33)], 'iterations': 1 } ],
    'expected': [('PORTC',0xF0)],
    },
    {'description': 'Test 19: PINA: 0x34 => PORTC: 0xF0',
    'steps': [ {'inputs': [('PINA',0x34)], 'iterations': 1 } ],
    'expected': [('PORTC',0xF0)],
    },
    {'description': 'Test 20: PINA: 0x35 => PORTC: 0xB8',
    'steps': [ {'inputs': [('PINA',0x35)], 'iterations': 1 } ],
    'expected': [('PORTC',0xB8)],
    },
    {'description': 'Test 21: PINA: 0x36 => PORTC: 0xB8',
    'steps': [ {'inputs': [('PINA',0x36)], 'iterations': 1 } ],
    'expected': [('PORTC',0xB8)],
    },
    {'description': 'Test 22: PINA: 0x37 => PORTC: 0xBC',
    'steps': [ {'inputs': [('PINA',0x37)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBC)],
    },
    {'description': 'Test 23: PINA: 0x38 => PORTC: 0xBC',
    'steps': [ {'inputs': [('PINA',0x38)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBC)],
    },
    {'description': 'Test 24: PINA: 0x39 => PORTC: 0xBC',
    'steps': [ {'inputs': [('PINA',0x39)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBC)],
    },
    {'description': 'Test 25: PINA: 0x3A => PORTC: 0xBE',
    'steps': [ {'inputs': [('PINA',0x3A)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBE)],
    },
    {'description': 'Test 26: PINA: 0x3B => PORTC: 0xBE',
    'steps': [ {'inputs': [('PINA',0x3B)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBE)],
    },
    {'description': 'Test 27: PINA: 0x3C => PORTC: 0xBE',
    'steps': [ {'inputs': [('PINA',0x3C)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBE)],
    },
    {'description': 'Test 28: PINA: 0x3D => PORTC: 0xBF',
    'steps': [ {'inputs': [('PINA',0x3D)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBF)],
    },
    {'description': 'Test 29: PINA: 0x3E => PORTC: 0xBF',
    'steps': [ {'inputs': [('PINA',0x3E)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBF)],
    },
    {'description': 'Test 30: PINA: 0x3F => PORTC: 0xBF',
    'steps': [ {'inputs': [('PINA',0x3F)], 'iterations': 1 } ],
    'expected': [('PORTC',0xBF)],
    },
    {'description': 'Test 31: PINA: 0x7D => PORTC: 0x3F',
    'steps': [ {'inputs': [('PINA',0x7D)], 'iterations': 1 } ],
    'expected': [('PORTC',0x3F)],
    },
    {'description': 'Test 32: PINA: 0x6E => PORTC: 0x3F',
    'steps': [ {'inputs': [('PINA',0x6E)], 'iterations': 1 } ],
    'expected': [('PORTC',0x3F)],
    },
    {'description': 'Test 33: PINA: 0x1F => PORTC: 0x3F',
